...
const signUpUser = (req, res) => {
  ...
  req.on('end', () => {
      ...
      const { first_name, last_name, email, phone_number, username, password } = requestBody;

      // Insert user into the database using the query from the queries file
      pool.query(
          queries.addUser, // Use the query from the queries file
