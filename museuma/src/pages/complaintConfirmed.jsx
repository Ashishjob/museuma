            ...
            <div className='bg-white p-12 rounded-xl'>
                {loading ? (
                    ...
                    <div className="checkmark flex flex-col text-center text-2xl items-center bg-[#bfbaa3] p-4 rounded-xl">
                        ...
                        <h1>Complaint confirmed</h1>
                        <p>Thank you for bringing this to our attention. <br></br>We value your feedback and will investigate the matter promptly. We are committed to improving your experience.</p>
                    </div>
                )}
...
export default ComplaintConfirmed;