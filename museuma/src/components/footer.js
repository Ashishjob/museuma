function Footer() {
  return (
    <footer class="body-font bg-[#615D51] text-white">
      <div class="container px-5 py-8 flex items-center sm:flex-row flex-col">
        ...
        <span class="inline-flex ml-auto -mr-72 sm:mt-0 mt-4 justify-center sm:justify-start">
  <a class="text-white" href="https://github.com/Ashishjob/museuma" target="__blank">
